...
async def test_task_request():
    ...
    print(f"[PASS] TaskRequest created successfully")
...
async def test_task_record():
    ...
    print(f"[PASS] TaskRecord created and serialized")
    ...
    print(f"[PASS] TaskRecord.from_row() works correctly")
    print()
...
async def test_a2a_message():
    ...
    print(f"[PASS] A2AClient.send_message() signature updated")
...
async def test_lead_analyst_state():
    ...
    print(f"[PASS] LeadAnalystState extended correctly")
...
async def test_lead_analyst_executor():
    ...
    print(f"[PASS] prepare_input() extracts metadata correctly")
